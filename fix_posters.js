...
files.forEach(f => {
    try {
        ...
        t = t.replace(
            ...
            "img.src = m.poster.startsWith('http') ? m.poster : '/assets/images/' + (m.poster.includes('.') ? m.poster : m.poster + '.webp');"
        );
        ...
        t = t.replace(
            ...
            `src="\${movie.poster.startsWith('http') ? movie.poster : '../assets/images/' + (movie.poster.includes('.') ? movie.poster : movie.poster + '.webp')}"`
        );
